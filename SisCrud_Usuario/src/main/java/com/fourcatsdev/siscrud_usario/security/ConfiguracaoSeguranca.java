package com.fourcatsdev.siscrud_usario.security;
...
public class ConfiguracaoSeguranca extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/auth/user/*").hasAnyAuthority("USER","ADMIN","ENFERMEIRO")
		.antMatchers("/auth/admin/*").hasAnyAuthority("ADMIN")
		.antMatchers("/auth/enferm/*").hasAnyAuthority("ENFERMEIRO")
